    ...
    with open(input_file, 'r') as data:
        while True:
            ...
            while True:
                ...
                if all_zeros:
                    break
                stage_firsts.append(new_numbers[0])
                current_numbers = new_numbers
            stage_firsts.reverse()
            extrapolated = 0
            for stage_last in stage_firsts:
                extrapolated = -1 * (extrapolated - stage_last)
            extrapolated_sum += extrapolated
